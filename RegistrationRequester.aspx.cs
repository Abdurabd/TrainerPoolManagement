...
{
    public partial class RegistrationRequester : System.Web.UI.Page
    {
        ...
        protected void AdmnRgstr_Click1(object sender, EventArgs e)
        {
            bo ob1 = new bo();
            ...
            bal sba1 = new bal();
            int result = sba1.AddBALRecord(ob1);
            if (result > 0)
            {
