<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistrationTrainer.aspx.cs" Inherits="TrainerPoolManagement.RegistrationTrainer" %>
...
&nbsp;&nbsp;&nbsp;
                ...
                <tr>
                    ...
                    <td class="auto-style11">
                        ...
                        <asp:TextBox ID="UserType" runat="server" CssClass="txtBox" Text="Trainer"></asp:TextBox>
                ...
                <tr>
                    <td colspan="2">
                        <asp:Button ID="AdmnRgstr" runat="server" Text="Register" class="regImage" OnClientClick="return validate()" OnClick="AdmnRgstr_Click2"/>
                       </td>
                </tr>   
                <tr>
                    <td colspan="2">
