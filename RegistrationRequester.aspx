<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistrationRequester.aspx.cs" Inherits="TrainerPoolManagement.RegistrationRequester" %>
...
&nbsp;&nbsp;&nbsp;
                ...
                <tr>
                    ...
                    <td class="auto-style11">
                        ...
                        <asp:TextBox ID="UserType" runat="server" CssClass="txtBox" Text="Requestor"></asp:TextBox>
                ...
                <tr>
                    <td colspan="2">
                        <asp:Button ID="AdmnRgstr" runat="server" Text="Register" class="regImage" OnClientClick="return validate()" OnClick="AdmnRgstr_Click1"/>
                       </td>
                </tr>   
                <tr>
                    <td colspan="2">
